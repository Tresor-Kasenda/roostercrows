            ...
            <div>
                ...
                <div>
                    <div class="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
                        <div>
                            <h6 class="text-lg font-medium text-gray-700 dark:text-gray-200">Categories</h6>
                        ...
                        <div>
                            <h6 class="text-lg font-medium text-gray-700 dark:text-gray-200">Products</h6>
                            <ul class="mt-4 list-inside space-y-4">
                                <li>
                                    <a href="#" class="transition hover:text-primary">About</a>
                                </li>
                        ...
                        <div>
                            <h6 class="text-lg font-medium text-gray-700 dark:text-gray-200">Ressources</h6>
                            <ul class="mt-4 list-inside space-y-4">
                                <li>
                                    <a href="#" class="transition hover:text-primary">About</a>
                                </li>
                        ...
                        <div class="col-span-2 sm:col-span-3 md:col-span-2">
                            <h6 class="text-lg font-medium text-gray-700 dark:text-gray-200">Contact</h6>
                            <ul class="mt-4 list-inside space-y-4">
                                <li>
                                    <a href="tel:+243814434054" class="transition hover:text-primary">
                                        +243814434054
                                    </a>
                                </li>
                                <li>
                                    <a href="mailto:infos@roostercrowsinvest.com" class="transition hover:text-primary">
                                        infos@roostercrowsinvest.com
                                    </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="flex justify-between border-t border-cyan-800 py-8 text-gray-200">
