<section class=" mt-10 lg:mt-20 mb-10 lg:mb-20">
    <div class="container mx-auto max-w-6xl px-4">
        <div class="text-center mx-auto mb-20 space-y-4">
            <h2 class="text-center text-3xl sm:text-5xl lg:text-6xl text-white font-bold">Ours Services</h2>
        ...
        <div class="relative bg-gray-600/10 p-4 rounded-xl shadow-lg">
            <div aria-hidden="true"
                 class="absolute inset-0 m-auto grid h-3/5 w-3/5 grid-cols-2 -space-x-52 opacity-40 dark:opacity-60">
                <div
                    class="h-full rounded-full bg-gradient-to-br from-purple-500/20 to-purple-700/20 blur-[106px]  dark:from-blue-700/10"></div>
                <div
            ...
            <div class="grid relative grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 h-[28rem] md:h-[19rem]">
                <div
                    ...
                    <div class="flex items-center justify-center mb-2">
                        <h3 class="text-xl font-bold text-white mr-2">Service Title</h3>
                    </div>
                ...
                <div
                    ...
                    <p class="text-base text-slate-400 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Nullam id felis
                        et
                        ipsum bibendum ultrices.</p>
