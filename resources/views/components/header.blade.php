...
<div class="mx-auto lg:max-w-6xl w-full px-5 sm:px-10 md:px-12 lg:px-5" data-navbar="true">
    <div class="w-full flex justify-between h-14 items-center">
        <div class="h-full flex items-center gap-x-4 text-gray-700">
            <a href="tel:+243814434054" class="flex gap-1 text-sm">
                <svg xmlns="http://www.w3.org/2000/svg"
                     class="h-5 w-5 hover:font-medium hover:text-red-600 text-slate-800 transition scale-75 ease-out"
                ...
                <span class="hidden sm:flex text-sm text-slate-800 font-medium">+243 814 434 054 </span>
            </a>
            <a href="mailto:infos@roostercrowsinvest.com" class="flex gap-1 items-center">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                         class="h-5 w-5 hover:font-medium hover:text-red-600 transition text-slate-800 scale-75 ease-out">
                ...
                <span class="hidden sm:flex text-sm text-slate-800 font-medium">infos@roostercrowsinvest.com</span>
            </a>
        </div>
        <div
            ...
            <a href="#facebook" class="transition ease-linear text-slate-800 hover:text-pink-700">
            ...
            <a href="#twitter" class="transition ease-linear text-slate-800 hover:text-pink-700">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <a href="#linkedin" class="transition ease-linear text-slate-800 hover:text-pink-700">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="flex items-center min-w-max">
            <a href="{{ route('home') }}" class="text-xl font-semibold flex items-center gap-x-2">
                <span class="text-lg text-gray-700">
                    <img src="{{ asset('assets/images/review.webp') }}" class="w-36" alt="tailus logo" width="144"
                         height="48"/>
                </span>
            </a>
        </div>
